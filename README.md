...
- [x] **Backend listens for WebSocket connection** - Websocket functionality in service/index.js and service/peerProxy.js.
- [x] **Frontend makes WebSocket connection** - Frontend Websocket functionality used in src/storyPage.jsx.
- [x] **Data sent over WebSocket connection** - Messages sent and received over Websocket connection.
- [x] **WebSocket data displayed** - Websocket data is displayed in the application.
- [x] **Application is fully functional** - Application is fully functional. No placeholders.
